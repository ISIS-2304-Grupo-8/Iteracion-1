...
public interface ProductoRepository extends JpaRepository<ProductoEntity, Integer> {
        ...
        ProductoEntity darProducto(@Param("id_producto") Integer id_producto,
        ...
        void crearProducto(@Param("nombre") String nombre, @Param("costo") Double costo,
                        @Param("tipo_servicio") String tipo_servicio);
        ...
        void actualizarProducto(@Param("id_producto") Integer id_producto, @Param("nombre") String nombre,
                        @Param("costo") Double costo, @Param("tipo_servicio") String tipo_servicio);
