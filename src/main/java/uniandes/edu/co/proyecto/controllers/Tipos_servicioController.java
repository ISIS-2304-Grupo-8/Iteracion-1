...
public class Tipos_servicioController {
    ...
    public String Tipos_habitacion(Model model){
        model.addAttribute("Tipos_habitacion", tipoServicioRepository.darTiposDeHabitaciones());
    ...
    public String Tipo_habitacionGuardar(@ModelAttribute TipoHabitacionEntity Tipo_habitacion){
        tipoServicioRepository.insertarTipoDeHabitacion(Tipo_habitacion.getCosto(),
    ...
    public String Tipo_habitacionEditarForm(@PathVariable("id") int id, Model model){
        TipoHabitacionEntity tipoHabitacionEntity = tipoServicioRepository.darTipoDeHabitacion(id);
    ...
    public String Tipo_habitacionEditarGuardar(@PathVariable("id") int id, @ModelAttribute TipoHabitacionEntity tipoHabitacionEntity){
        tipoServicioRepository.actualizarTipoDeHabitacion(id, tipoHabitacionEntity.getCosto(), tipoHabitacionEntity.getCapacidad(),
    ...
    public String Tipo_habitacionEliminar(@PathVariable("id") int id){
        tipoServicioRepository.eliminarTipoDeHabitacion(id);
        return "redirect:/tipos_de_habitaciones";
    }
}
